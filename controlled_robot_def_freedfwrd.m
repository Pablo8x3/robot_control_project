...
for k = 1:length(figHandles)
    fig = figHandles(k);
    % Create filename
    fileName = fullfile(folderName, ['ff' num2str(k) '_unc.png']);
    % Save as PNG
    saveas(fig, fileName);
end
